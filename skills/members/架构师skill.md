...
3. 架构师的第三职责是把任务拆成前端、后端、测试三个可交接的单工具任务。
4. 架构师禁止直接替前端AI、后端AI、测试AI执行实现工作。
...
2. 架构师必须确保产出的文档路径会被前端AI、后端AI、测试AI直接使用。
...
1. 架构师向测试AI发派任务时，必须同时提供以下输入物：
   ...
   前端测试目录路径
   后端测试目录路径
2. 测试AI接收任务后，必须先执行 skills/members/测试skill.md。
3. 架构师必须明确写出测试AI需要检查文件越界、契约一致性、自动化测试结果。
