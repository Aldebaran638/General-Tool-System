...
本文说明如何把“项目管理面板”配置为飞书企业自建应用，并启用浏览器 OAuth 授权登录。
...
New-NetFirewallHyperVRule -Name "WSL-103xx-In" -DisplayName "WSL 10300-10310" -Direction Inbound -VMCreatorId '{40E0AC32-46A5-438A-A0B2-2B479E8F2E90}' -Protocol TCP -LocalPorts 10300-10310 -Action Allow
